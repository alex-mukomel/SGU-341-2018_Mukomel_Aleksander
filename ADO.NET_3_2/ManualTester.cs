...
namespace ADO.NET_3_2
{
    ...
    {
        public ManualTester(string name, string surname, Rank rank,
        ...
        public override int FindBugs()
        {
            ...
            Console.WriteLine("Manual tester {0} {1} found {2} {3} bugs", Name, Surname, count, bugs);
            return count;
        }

        public override void TestCode()
        {
            Console.WriteLine("Manual tester {0} {1} tested the code", Name, Surname);
        }

        public override Tester Clone()
        {
            return new ManualTester(Name, Surname, Rank, Experience, TotalSalary);
        }
    }
}
